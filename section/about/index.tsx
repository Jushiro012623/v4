  ...
  return (
    <div className="min-h-screen w-full">
      <div className="max-w-4xl mx-auto ">
        <p className="text-white font-extralight text-5xl text- tracking-tight leading-tight">
          Software Developer with 15+ years of experience in full-stack
          development, combining clean backend architecture with responsive,
